...
const formSchema = z.object({
  ...
  facultyUid: z.string().min(1, "Faculty ID is required"),
...
export function AddAppointmentForm() {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      department: "",
      facultyName: "",
      facultyUid: "", // Added facultyUid to default values
      course: "",
      section: "",
      date: undefined,
      startTime: "",
  ...
  const handleFacultyChange = (facultyName: string) => {
    // Find the corresponding faculty UID when faculty name is selected
    const selectedFaculty = facultyList.find(faculty => faculty.name === facultyName)
    form.setValue('facultyName', facultyName)
    form.setValue('facultyUid', selectedFaculty?.id || '')
  }
  return (
