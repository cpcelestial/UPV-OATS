...
import { getFirestore, doc, updateDoc, getDoc, writeBatch, collection } from "firebase/firestore";
...
export const handleAccept = async (appointmentId: string) => {
  try {
    ...
    const timeSlotRef = collection(db, "timeSlots");
    ...
    const timeslotId = userId;
    
    if (!timeslotId) {
      throw new Error("Timeslot ID not found in appointment data");
    }
    ...
    console.log(`Appointment ${appointmentId} approved successfully, timeslot ${timeslotId} updated to booked`);
